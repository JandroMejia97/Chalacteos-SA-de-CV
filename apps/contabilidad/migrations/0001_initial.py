# Generated by Django 2.1.2 on 2018-11-17 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_cuenta', models.CharField(error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Ingrese el nombre de la cuenta', max_length=50, null=True, verbose_name='Nombre de la cuenta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_inicio_periodo', models.DateTimeField(auto_now=True, error_messages={'empty': 'Este campo no debe quedar vacío'}, help_text='Fecha de inicio del nuevo período contable', null=True, verbose_name='Fecha de inicio')),
