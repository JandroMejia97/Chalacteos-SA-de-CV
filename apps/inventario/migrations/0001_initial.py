    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_detalle', models.DecimalField(decimal_places=2, help_text='Ingrese el total de la compra o venta (impuestos incluídos)', max_digits=1000, validators=[django.core.validators.MinValueValidator(0, message='Este campo debe ser positivo')], verbose_name='Cantidad')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_total_factura', models.DecimalField(decimal_places=2, help_text='Ingrese el sub total antes de impuestos de la compra o venta', max_digits=1000, validators=[django.core.validators.MinValueValidator(0, message='Este campo debe ser positivo')], verbose_name='Sub Total')),
                ('total_factura', models.DecimalField(decimal_places=2, help_text='Ingrese el total de la compra o venta (impuestos incluídos)', max_digits=1000, validators=[django.core.validators.MinValueValidator(0, message='Este campo debe ser positivo')], verbose_name='Total')),
                ...
                ('id_compra', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Compra', verbose_name='Compra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_factura', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Factura', verbose_name='Factura')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_movimiento', models.DateTimeField(auto_now=True, verbose_name='Fecha')),
                ...
                ('id_kardex', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Kardex', verbose_name='Kardex')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_movimiento', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Movimiento')),
            ],
            options={
                'verbose_name': 'Saldo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_cliente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Cliente', verbose_name='Cliente')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.AddField(
            model_name='producto',
            name='id_recurso',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='inventario.Recurso', verbose_name='Recurso'),
        ),
        migrations.AddField(
            model_name='materiaprima',
            name='id_producto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Producto', verbose_name='Producto'),
        ),
        migrations.AddField(
            model_name='materiaprima',
            name='id_recurso',
        ...
        migrations.AddField(
            model_name='kardex',
            name='id_recurso',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Recurso', verbose_name='Recurso'),
        ),
        migrations.AddField(
            model_name='facturaimpuesto',
            name='id_impuesto',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Impuesto', verbose_name='Impuesto'),
        ),
        migrations.AddField(
            model_name='factura',
            name='id_venta',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Venta', verbose_name='Venta'),
        ),
        migrations.AddField(
            model_name='detalle',
            name='id_factura',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Factura', verbose_name='Factura'),
        ),
        migrations.AddField(
            model_name='detalle',
            name='id_materia_prima',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.MateriaPrima', verbose_name='Materia Prima'),
        ),
        migrations.AddField(
            model_name='detalle',
            name='id_producto',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Producto', verbose_name='Producto'),
        ),
        migrations.AddField(
            model_name='compra',
            name='id_proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='inventario.Proveedor', verbose_name='Proveedor'),
        ),
    ]
