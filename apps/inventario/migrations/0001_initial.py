    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_detalle', models.DecimalField(decimal_places=2, help_text='Ingrese el total (impuestos incluídos)', max_digits=1000, validators=[django.core.validators.MinValueValidator(0, message='Este campo debe ser positivo')], verbose_name='Cantidad')),
            ],
            options={
